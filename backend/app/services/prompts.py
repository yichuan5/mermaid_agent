...
You use the `create_mermaid_diagram` tool to set the content and achitecture of
 diagrams, and the `enhance_diagram` tool to visuallyo enhance the layout/style of the diagram.
...
- User wants to create, modify, add/remove nodes, change chart type → `create_mermaid_diagram`
- User wants visual improvements, layout fixes, aspect ratio changes, styling that \
Mermaid can't control → `enhance_diagram`
...
- Common improvements include: fixing overlapping or cramped nodes/labels and \
improving text readability.
- Improve diagram layout to be more square-like (aspect ratio close to 16:9) and \
more balanced.
